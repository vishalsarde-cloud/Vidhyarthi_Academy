...
import type { Payment, Enrollment, Course, Student } from "@/lib/types"
...
export function ReceiptViewer({ isOpen, onClose, payment, enrollment, course, student }: ReceiptViewerProps) {
