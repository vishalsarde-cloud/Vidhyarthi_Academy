...
export const registeredStudents= new Map([
  [
    "student@gmail.com",
    {
      id: "student-001",
...
export function validateCredentials(email, password): User | null {
  // Check admin
...
export function registerStudent(data): User {
...
export function getStudentByEmail(email): Student | undefined {
...
export function updateStudentProfile(email, data): User | null {
  const student = registeredStudents.get(email)
