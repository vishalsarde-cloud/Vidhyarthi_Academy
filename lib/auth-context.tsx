...
interface AuthContextType {
  ...
  logout: () => void
  register: (data: Omit<Student, "id" | "createdAt">) => Promise<{ success: boolean; error?: string }>
  updateProfile: (data: Partial<Student>) => Promise<{ success: boolean; error?: string }>
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const register = async (data: Omit<Student, "id" | "createdAt">): Promise<{ success: boolean; error?: string }> => {
    setIsLoading(true)
  ...
  const updateProfile = async (data: Partial<Student>): Promise<{ success: boolean; error?: string }> => {
